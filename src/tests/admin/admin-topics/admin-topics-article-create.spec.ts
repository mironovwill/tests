...
const testCaseInfo = {
  ...
  story: 'Добавить материал с типом "Статья"',
  description: 'Тест проверяет успешное создание материала c типом "Статья" в админ-панели.',
  userRole: 'Superadmin',
  layer: 'ui_tests',
...
test('Создание топика с типом "Статья"', { tag: ['@Admin', '@Regress', '@UI'] }, async ({ adminTopicsPage }) => {
