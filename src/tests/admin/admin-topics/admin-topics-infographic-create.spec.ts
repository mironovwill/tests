...
const testCaseInfo = {
  ...
  story: 'Добавить материал с типом "Инфографика"',
  description: 'Тест проверяет успешное создание материала c типом "Инфографика" в админ-панели.',
  userRole: 'Superadmin',
  layer: 'ui_tests',
...
const topicInfo = {
  topicName: 'Инфографика',
  description: 'Test description',
  categories: [TopicCategories.WORK_ORGANIZATION],
  topicType: TopicType.INFOGRAPHIC,
...
test('Создание топика с типом "Инфографика"', { tag: ['@Admin', '@Regress', '@UI'] }, async ({ adminTopicsPage }) => {
