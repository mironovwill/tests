...
const testCaseInfo = {
  ...
  story: 'Добавить материал с типом "Видео"',
  description: 'Тест проверяет успешное создание материала c типом "Видео" в админ-панели.',
  userRole: 'Superadmin',
  layer: 'ui_tests',
...
test('Создание топика с типом "Видео"', { tag: ['@Admin', '@Regress', '@UI'] }, async ({ adminTopicsPage }) => {
