...
const testCaseInfo = {
  ...
  story: 'Добавить материал с типом "Опрос"',
  description: 'Тест проверяет успешное создание материала c типом "Опрос" в админ-панели.',
  userRole: 'Superadmin',
  layer: 'ui_tests',
...
test('Создание топика с типом "Опрос"', { tag: ['@Admin', '@Regress', '@UI'] }, async ({ adminTopicsPage }) => {
